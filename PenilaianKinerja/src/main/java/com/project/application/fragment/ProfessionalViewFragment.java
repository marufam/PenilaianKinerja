 ...
 */
public class ProfessionalViewFragment extends Fragment {
    ...
    public static ProfessionalViewFragment newInstance() {
        return new ProfessionalViewFragment();
    }
...
//        Toast.makeText(getContext(), ""+Jenisguru.toString(), Toast.LENGTH_SHORT).show();
        if(Jenisguru.toString().equalsIgnoreCase("guru matpel")){
             kodekategori = "KTG0000004";
        }else{
             kodekategori = "KTG0000008";
        }
