 ...
 */
public class KepribadianViewFragment extends Fragment {
    ...
    public static KepribadianViewFragment newInstance() {
        return new KepribadianViewFragment();
    }
...
//        Toast.makeText(getContext(), ""+Jenisguru.toString(), Toast.LENGTH_SHORT).show();
        if(Jenisguru.toString().equalsIgnoreCase("guru matpel")){
             kodekategori = "KTG0000002";
        }else{
             kodekategori = "KTG0000006";
        }
